...
public class TargetHUDSettings extends Mod {
    ...
    public BooleanSetting noDisplayWhenNoPlayer = new BooleanSetting("Super long setting", false);
    ...
    public TargetHUDSettings() {
        ...
        addSettings(range, displayAsHearts, noDisplayWhenNoPlayer, ignoreFriendly);
    }
